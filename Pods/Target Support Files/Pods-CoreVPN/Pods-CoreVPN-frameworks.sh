...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaAdSupport/AppMetricaAdSupport.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaCore/AppMetricaCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaCoreExtension/AppMetricaCoreExtension.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaIDSync/AppMetricaIDSync.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaIdentifiers/AppMetricaIdentifiers.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaKeychain/AppMetricaKeychain.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaLibraryAdapter/AppMetricaLibraryAdapter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaLog/AppMetricaLog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaLogSwift/AppMetricaLogSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AppMetricaSynchronization/AppMetricaSynchronization.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DivKit/DivKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DivKitBinaryCompatibilityFacade/DivKitBinaryCompatibilityFacade.framework"
